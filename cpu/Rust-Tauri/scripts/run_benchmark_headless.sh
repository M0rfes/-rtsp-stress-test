...
echo "=== RTSP 30-Stream CPU Benchmark (Rust Tauri) ==="
...
BINARY_PATH="$DIR/src-tauri/target/release/rtsp-stress-test-tauri-cpu"
if [ ! -f "$BINARY_PATH" ]; then
  echo "[*] Building Rust Tauri benchmark application (Release)..."
  npm run build
fi
...
echo "[*] Launching Tauri CPU application..."
