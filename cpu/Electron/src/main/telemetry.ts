...
export class TelemetryManager {
  ...
  public flushToDisk(): void {
    ...
    try {
      ...
      console.log(`[Telemetry] Stats: Acceptable (25-30: ${payload.fps_stream_seconds.acceptable['25_to_30_fps']}, 20-24: ${payload.fps_stream_seconds.acceptable['20_to_24_fps']}), Unacceptable (<5: ${payload.fps_stream_seconds.unacceptable['under_5_fps']})`);
    } catch (err) {
